"""
Fallback reasoning generator module when Sketch-of-Thought is not available.
"""
...
class FallbackReasoningGenerator:
    """
    Fallback reasoning generator for when Sketch-of-Thought is not available.
    
    This provides basic reasoning patterns similar to SoT but without requiring
    the external package.
    """
    
    def __init__(self):
        """Initialize the fallback reasoning generator."""
        pass
    
    def generate(self, text: str, issues: List[Dict[str, Any]], 
                 paradigm: str = "conceptual_chaining") -> Optional[str]:
        """
        Generate reasoning based on the paradigm and detected issues.
